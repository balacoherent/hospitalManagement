...
public class DiseaseController {
  ...
  /*  @RolesAllowed(value="ADMIN")
    ...
    public BaseResponseRep<Disease> deletesoft(@PathVariable int id) {
        BaseResponseRep<Disease> baseResponseRep = null;
        baseResponseRep = BaseResponseRep.<Disease>builder().Data(diseaseInterface.deleteById(id)).build();
        return baseResponseRep;
    }
