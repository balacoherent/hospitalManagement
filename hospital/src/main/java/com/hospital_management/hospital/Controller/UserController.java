...
public class UserController {
    ...
    public BaseResponseRep<UserRoleDTO> logOfUser(@RequestBody UserRoleDTO userRoleDTO) {
        BaseResponseRep<UserRoleDTO> baseResponseRep=null;
        baseResponseRep = BaseResponseRep.<UserRoleDTO>builder().Data(userInterface.logOfUser(userRoleDTO)).build();
        return baseResponseRep;
    }
